...
namespace Historique.Business.ApiGoogleAnalytics
{
    public class ReportingHelper
    {
        ...
        public class OptionalValues
        {
            ...
            private DataResource.GaResource.GetRequest.SamplingLevelEnum samplingLevel = DataResource.GaResource.GetRequest.SamplingLevelEnum.DEFAULT;
            ...
            /// </summary>
            public DataResource.GaResource.GetRequest.SamplingLevelEnum Sampling { get { return samplingLevel; } set { samplingLevel = value; } }
            ...
            public OptionalValues()
            {
                ...
                this.sort = null;
                this.segment = null;
                this.samplingLevel = DataResource.GaResource.GetRequest.SamplingLevelEnum.DEFAULT;
